...
# jby 2025.09.05 (initials and date of last edit)
...
# Write code to assume the project directory is the working directory
# But keep this command handy as a comment
# setwd("~/Documents/Active_projects/project_template")
...
# a data file
write.table(out, arg2, sep=",", col.names=TRUE, row.names=FALSE, quote=TRUE)
